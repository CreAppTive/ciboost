function AppConfigBadgesWindow() {
	...
	var webview = Titanium.UI.createWebView({url:'/html-app/badges.html',backgroundColor:'transparent'});
...
module.exports = AppConfigBadgesWindow;
