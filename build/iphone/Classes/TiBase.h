...
// in simulator we redefine to format for ciboost Developer console
...
{\
	NSString * exceptionName = [@"org.ciboost." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ciboost";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIciboostNativeItemNone = -1, 
	UIciboostNativeItemSpinner = -2,
	UIciboostNativeItemProgressBar = -3,
	
	UIciboostNativeItemSlider = -4,
	UIciboostNativeItemSwitch = -5,
	UIciboostNativeItemMultiButton = -6,
	UIciboostNativeItemSegmented = -7,
	
	UIciboostNativeItemTextView = -8,
	UIciboostNativeItemTextField = -9,
	UIciboostNativeItemSearchBar = -10,
	
	UIciboostNativeItemPicker = -11,
	UIciboostNativeItemDatePicker = -12,
	
	UIciboostNativeItemInfoLight = -13,
	UIciboostNativeItemInfoDark = -14,
	
	UIciboostNativeItemDisclosure = -15,
	
	UIciboostNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ciboost instances of
