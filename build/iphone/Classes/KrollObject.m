 ...
 * Copyright (c) 2009-2011 by ciboost, Inc. All Rights Reserved.
...
//@interface ciboostObject : NSObject
//@end

@interface ciboostObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ciboostObject class]])
		{
			for (NSString *key in [[(ciboostObject*)o modules] allKeys])
			{
